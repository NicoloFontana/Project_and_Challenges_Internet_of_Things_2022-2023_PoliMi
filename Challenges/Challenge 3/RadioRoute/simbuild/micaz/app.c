...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bd4458, const void *arg_0xb7bd45f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b858c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a2f840), 
int (*key_eq_fn)(void *arg_0xb7a2fc88, void *arg_0xb7a2fe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78fe9b8, int arg_0xb78feb10);
static double RandomUniform(void );
...
static void print_msg_type(uint16_t node, uint16_t sending_msg_type, bool is_sent);
#line 43
static inline void print_rt(routing_table_entry_t rt[]);
...
static inline void init_rt(routing_table_entry_t rt[]);
#line 67
static bool is_dst_in_rt(routing_table_entry_t rt[], uint16_t dst);
#line 84
static inline void update_rt(routing_table_entry_t rt[], uint16_t dst, uint16_t next_hop, uint16_t cost);
#line 112
static uint16_t get_next_hop(routing_table_entry_t rt[], uint16_t dst);
#line 129
static uint16_t get_cost(routing_table_entry_t rt[], uint16_t dst);
#line 150
static radio_route_msg_t *create_data_msg(radio_route_msg_t *msg, uint16_t sender, uint16_t dst, uint16_t val);
#line 169
static inline radio_route_msg_t *create_route_req_msg(radio_route_msg_t *msg, uint16_t node_requested);
#line 184
static radio_route_msg_t *create_route_rep_msg(radio_route_msg_t *msg, uint16_t sender, uint16_t node_requested, uint16_t cost);
...
# 38 "RadioRouteC.nc"
routing_table_entry_t RadioRouteC$rt[1000][10];
char RadioRouteC$PERSON_CODE[1000][9];
...
uint16_t RadioRouteC$round[1000];


bool RadioRouteC$dbg_route_req_sent[1000];
bool RadioRouteC$dbg_route_rep_sent[1000];
bool RadioRouteC$dbg_route_req_received[1000];
bool RadioRouteC$dbg_route_rep_received[1000];
bool RadioRouteC$dbg_node_found[1000];


bool RadioRouteC$in_RT[1000];
uint16_t RadioRouteC$curr_cost[1000];
uint16_t RadioRouteC$new_cost[1000];
uint16_t RadioRouteC$led_idx[1000];
uint16_t RadioRouteC$next_hop[1000];


message_type RadioRouteC$sending_msg_type[1000];
radio_route_msg_t *RadioRouteC$msg[1000];
radio_route_msg_t *RadioRouteC$msg_received[1000];
...
static inline void RadioRouteC$update_led(uint16_t val);
#line 112
...
{
  LedsP$Led2$toggle();
  sim_log_debug(191U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 116
  ;
}
...
#line 82
{
  ...
  RadioRouteC$led_idx[sim_node()] = (RadioRouteC$PERSON_CODE[sim_node()][RadioRouteC$round[sim_node()]] - '0') % 3;
  if (TOS_NODE_ID == 6) {

      sim_log_debug(155U, "led", "Updating led %d at round %d with digit %d\n", RadioRouteC$led_idx[sim_node()], RadioRouteC$round[sim_node()], RadioRouteC$PERSON_CODE[sim_node()][RadioRouteC$round[sim_node()]] - '0');
    }
  switch (RadioRouteC$led_idx[sim_node()]) {
      case 0: 
  ...
  sim_log_debug(156U, "led", "New leds status: led0: %d led1: %d led2: %d\n", RadioRouteC$Leds$get() & 1, (RadioRouteC$Leds$get() & 2) / 2, (RadioRouteC$Leds$get() & 4) / 4);
  if (TOS_NODE_ID == 6) {
      sim_log_debug(157U, "led6", "Round %d, digit %d:\n\t\t led0: %d led1: %d led2: %d\n\n", RadioRouteC$round[sim_node()], RadioRouteC$PERSON_CODE[sim_node()][RadioRouteC$round[sim_node()]] - '0', RadioRouteC$Leds$get() & 1, (RadioRouteC$Leds$get() & 2) / 2, (RadioRouteC$Leds$get() & 4) / 4);
    }
  RadioRouteC$round[sim_node()]++;
  RadioRouteC$round[sim_node()] = RadioRouteC$round[sim_node()] % 8;
}
...
#line 101
    {
      for (i = 0; i < 10; i++) {
          if (rt[i].destination == 0 && rt[i].next_hop == 0 && rt[i].cost == 65535) {
...
#line 43
{
  ...
  for (i = 0; i < 10; i++) {
      sim_log_debug(52U, "dbg", "RT[%d] = nxt %d dst %d cost %d\n", i, rt[i].next_hop, rt[i].destination, rt[i].cost);
    }
}
...
#line 177
{
  ...
  RadioRouteC$msg_received[sim_node()] = (radio_route_msg_t *)payload;
  switch (RadioRouteC$msg_received[sim_node()]->type) {
      case DATA_MSG: 
        print_msg_type(TOS_NODE_ID, RadioRouteC$msg_received[sim_node()]->type, FALSE);
      if (RadioRouteC$msg_received[sim_node()]->destination == TOS_NODE_ID) {
          sim_log_debug(172U, "dbg", "DATA ARRIVED AT DESTINATION!\n");
          sim_log_debug(173U, "data", "Received data message from %d with value %d\n", RadioRouteC$msg_received[sim_node()]->sender, RadioRouteC$msg_received[sim_node()]->value);
        }
      else 
#line 191
        {
          RadioRouteC$in_RT[sim_node()] = is_dst_in_rt(RadioRouteC$rt[sim_node()], RadioRouteC$msg_received[sim_node()]->destination);
          if (RadioRouteC$in_RT[sim_node()]) {
              RadioRouteC$sending_msg_type[sim_node()] = DATA_MSG;
              RadioRouteC$next_hop[sim_node()] = get_next_hop(RadioRouteC$rt[sim_node()], RadioRouteC$msg_received[sim_node()]->destination);
              RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
              RadioRouteC$msg[sim_node()] = create_data_msg(RadioRouteC$msg[sim_node()], RadioRouteC$msg_received[sim_node()]->sender, RadioRouteC$msg_received[sim_node()]->destination, RadioRouteC$msg_received[sim_node()]->value);
              RadioRouteC$generate_send(RadioRouteC$next_hop[sim_node()], &RadioRouteC$packet[sim_node()], RadioRouteC$sending_msg_type[sim_node()]);
            }
          else 
#line 199
            {
              sim_log_error(174U, "radio_rec", "ERROR!! Routed as next hop for %d without knowing destination\n", RadioRouteC$msg_received[sim_node()]->destination);
              print_rt(RadioRouteC$rt[sim_node()]);
            }
        }
      break;
      case ROUTE_REQ: 
        if (!RadioRouteC$dbg_route_req_received[sim_node()]) {
            print_msg_type(TOS_NODE_ID, RadioRouteC$msg_received[sim_node()]->type, FALSE);
          }
      if (RadioRouteC$msg_received[sim_node()]->node_requested == TOS_NODE_ID) {
          if (!RadioRouteC$dbg_node_found[sim_node()]) {
              sim_log_debug(175U, "dbg", "NODE REQUESTED FOUND!\n");
              RadioRouteC$dbg_node_found[sim_node()] = TRUE;
              RadioRouteC$dbg_route_rep_received[sim_node()] = TRUE;
            }
          RadioRouteC$sending_msg_type[sim_node()] = ROUTE_REP;
          RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
          RadioRouteC$msg[sim_node()] = create_route_rep_msg(RadioRouteC$msg[sim_node()], TOS_NODE_ID, RadioRouteC$msg_received[sim_node()]->node_requested, 1);
          RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], RadioRouteC$sending_msg_type[sim_node()]);
        }
      else 
#line 219
        {
          RadioRouteC$in_RT[sim_node()] = is_dst_in_rt(RadioRouteC$rt[sim_node()], RadioRouteC$msg_received[sim_node()]->node_requested);
          if (RadioRouteC$in_RT[sim_node()]) {
              if (!RadioRouteC$dbg_route_req_received[sim_node()]) {
                  sim_log_debug(176U, "dbg", "Found node %d in rt\n", RadioRouteC$msg_received[sim_node()]->node_requested);
                }
              RadioRouteC$sending_msg_type[sim_node()] = ROUTE_REP;
              RadioRouteC$new_cost[sim_node()] = get_cost(RadioRouteC$rt[sim_node()], RadioRouteC$msg_received[sim_node()]->node_requested) + 1;
              RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
              RadioRouteC$msg[sim_node()] = create_route_rep_msg(RadioRouteC$msg[sim_node()], TOS_NODE_ID, RadioRouteC$msg_received[sim_node()]->node_requested, RadioRouteC$new_cost[sim_node()]);
              RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], RadioRouteC$sending_msg_type[sim_node()]);
            }
          else 
#line 230
            {
              if (!RadioRouteC$dbg_route_req_received[sim_node()]) {
                  sim_log_debug(177U, "dbg", "Node %d not found in rt\n", RadioRouteC$msg_received[sim_node()]->node_requested);
                }
              RadioRouteC$sending_msg_type[sim_node()] = ROUTE_REQ;
              RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
              RadioRouteC$msg[sim_node()] = create_route_req_msg(RadioRouteC$msg[sim_node()], RadioRouteC$msg_received[sim_node()]->node_requested);
              RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], RadioRouteC$sending_msg_type[sim_node()]);
            }
        }
      if (TOS_NODE_ID != 6) {
          RadioRouteC$dbg_route_req_received[sim_node()] = TRUE;
        }
      break;
      case ROUTE_REP: 
        if (!RadioRouteC$dbg_route_rep_received[sim_node()]) {
            print_msg_type(TOS_NODE_ID, RadioRouteC$msg_received[sim_node()]->type, FALSE);
          }
      RadioRouteC$in_RT[sim_node()] = is_dst_in_rt(RadioRouteC$rt[sim_node()], RadioRouteC$msg_received[sim_node()]->node_requested);
      RadioRouteC$curr_cost[sim_node()] = get_cost(RadioRouteC$rt[sim_node()], RadioRouteC$msg_received[sim_node()]->node_requested);
      if (!RadioRouteC$in_RT[sim_node()] || RadioRouteC$msg_received[sim_node()]->cost < RadioRouteC$curr_cost[sim_node()]) {
          update_rt(RadioRouteC$rt[sim_node()], RadioRouteC$msg_received[sim_node()]->node_requested, RadioRouteC$msg_received[sim_node()]->sender, RadioRouteC$msg_received[sim_node()]->cost);
          if (!RadioRouteC$dbg_route_rep_received[sim_node()]) {
              sim_log_debug(178U, "dbg", "UPDATE RT: Next hop for node %d is %d with cost %d\n", RadioRouteC$msg_received[sim_node()]->node_requested, RadioRouteC$msg_received[sim_node()]->sender, RadioRouteC$msg_received[sim_node()]->cost);
            }
          if (TOS_NODE_ID == 1 && RadioRouteC$msg_received[sim_node()]->node_requested == 7) {
              sim_log_debug(179U, "dbg", "Node %d re-tries to send %d to node %d\n", 1, 5, 7);
              RadioRouteC$sending_msg_type[sim_node()] = DATA_MSG;
              RadioRouteC$next_hop[sim_node()] = get_next_hop(RadioRouteC$rt[sim_node()], 7);
              RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
              RadioRouteC$msg[sim_node()] = create_data_msg(RadioRouteC$msg[sim_node()], TOS_NODE_ID, 7, 5);
              RadioRouteC$generate_send(RadioRouteC$next_hop[sim_node()], &RadioRouteC$packet[sim_node()], RadioRouteC$sending_msg_type[sim_node()]);
            }
          else 
#line 262
  ...
  RadioRouteC$update_led(RadioRouteC$msg_received[sim_node()]->value);
  return bufPtr;
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76a0ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76a0ac8) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76a0ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb769e178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb769e178, msg, payload, len);
#line 78
...
#line 127
{
  ...
  sim_log_debug(163U, "radio", "Starting\n");
  if (err == SUCCESS) {
      sim_log_debug(164U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);
      if (TOS_NODE_ID == 1) {
          RadioRouteC$Timer1$startOneShot(5000);
          sim_log_debug(165U, "timer", "Starting Timer1\n");
          RadioRouteC$dbg_route_req_received[sim_node()] = TRUE;
        }
    }
  else {
      sim_log_error(166U, "radio", "Radio failed to start, retrying...\n");
...
#line 146
{
  sim_log_debug(167U, "radio", "Radio off\n");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76a0108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76a0108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73426a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73426a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73426a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb785a650){
#line 75
  switch (arg_0xb785a650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb785a650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73410a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73410a0, addr, msg, len);
#line 80
...
#line 296
{
  ...
  sim_log_debug(135U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 311
    if (mine == CpmModelC$outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(136U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 317
  sim_log_debug(137U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC$checkReceive(mine)) {
      sim_log_debug(138U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
  if (! mine->lost) {
...
#line 327
      ...
      sim_log_debug_clear(139U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(140U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(141U, "CpmModelC", " no acknowledgment requested.\n");
        }
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(143U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC$Model$shouldAck(mine->msg)) {
      ...
      CpmModelC$receiving[sim_node()] = 0;
      sim_log_debug_clear(145U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 374
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(146U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 396
    if (!CpmModelC$shouldReceive(power - noiseStr)) {
        sim_log_debug(147U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 400
      if (CpmModelC$receiving[sim_node()]) {
          sim_log_debug(148U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
          rcv->lost = 1;
        }
      else {
#line 404
        if (CpmModelC$transmitting[sim_node()] && rcv->start < CpmModelC$transmissionEndTime[sim_node()] && CpmModelC$transmissionEndTime[sim_node()] <= rcv->end) {
            sim_log_debug(149U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC$transmissionEndTime[sim_node()]);
            rcv->lost = 1;
          }
        else {
...
#line 412
  ...
  while (list != (void *)0) {
      if (!CpmModelC$shouldReceive(list->power - rcv->power)) {
          sim_log_debug(150U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 430
  sim_log_debug(151U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 439
  ...
  sim_log_debug(152U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 446
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(153U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 459
{
  ...
  sim_log_debug(154U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC$transmitting[sim_node()], sim_time_string());
}
...
#line 323
{
  ...
  if (RadioRouteC$locked[sim_node()]) {
      ...
      RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(packet, sizeof(radio_route_msg_t ));
      if (RadioRouteC$msg[sim_node()] == (void *)0) {
          return FALSE;
        }
      if (RadioRouteC$AMSend$send(address, packet, sizeof(radio_route_msg_t )) == SUCCESS) {


          if (RadioRouteC$sending_msg_type[sim_node()] == DATA_MSG) {
              print_msg_type(TOS_NODE_ID, RadioRouteC$sending_msg_type[sim_node()], TRUE);
            }
          if (RadioRouteC$sending_msg_type[sim_node()] == ROUTE_REQ && !RadioRouteC$dbg_route_req_sent[sim_node()]) {
              print_msg_type(TOS_NODE_ID, RadioRouteC$sending_msg_type[sim_node()], TRUE);
              RadioRouteC$dbg_route_req_sent[sim_node()] = TRUE;
            }
          if (RadioRouteC$sending_msg_type[sim_node()] == ROUTE_REP && !RadioRouteC$dbg_route_rep_sent[sim_node()]) {
              print_msg_type(TOS_NODE_ID, RadioRouteC$sending_msg_type[sim_node()], TRUE);
              RadioRouteC$dbg_route_rep_sent[sim_node()] = TRUE;
            }
...
#line 150
{
  ...
  sim_log_debug(168U, "timer", "Fired Timer1\n");
  sim_log_debug(169U, "dbg", "Node %d tries to send %d to node %d\n", 1, 5, 7);
  RadioRouteC$in_RT[sim_node()] = is_dst_in_rt(RadioRouteC$rt[sim_node()], 7);
  if (RadioRouteC$in_RT[sim_node()]) {
      sim_log_debug(170U, "dbg", "Found node %d in rt\n", 7);
      RadioRouteC$sending_msg_type[sim_node()] = DATA_MSG;
      RadioRouteC$next_hop[sim_node()] = get_next_hop(RadioRouteC$rt[sim_node()], 7);
      RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
      RadioRouteC$msg[sim_node()] = create_data_msg(RadioRouteC$msg[sim_node()], TOS_NODE_ID, 7, 5);
...
#line 164
    {
      sim_log_debug(171U, "dbg", "Node %d not found in rt\n", 7);
      RadioRouteC$sending_msg_type[sim_node()] = ROUTE_REQ;
      RadioRouteC$msg[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
      RadioRouteC$msg[sim_node()] = create_route_req_msg(RadioRouteC$msg[sim_node()], 7);
      RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], RadioRouteC$sending_msg_type[sim_node()]);
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb739d3a8){
#line 83
  switch (arg_0xb739d3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb739d3a8);
#line 83
      break;
#line 83
    }
...
#line 57
  {
    sim_log_debug(182U, "Init", "LEDS: initialized.\n");
...
#line 112
{
  ...
  sim_log_debug(158U, "boot", "Booting\n");
  sim_log_debug(159U, "boot", "Application booted.\n");
  init_rt(RadioRouteC$rt[sim_node()]);
  sim_log_debug(160U, "led", "Initial leds status: led0: %d led1: %d led2: %d\n", RadioRouteC$Leds$get() & 1, (RadioRouteC$Leds$get() & 2) / 2, (RadioRouteC$Leds$get() & 4) / 4);
  if (TOS_NODE_ID == 6) {
      sim_log_debug(161U, "led6", "Person code: %s\n\n", &RadioRouteC$PERSON_CODE[sim_node()]);
      sim_log_debug(162U, "led6", "Initial leds status:\n\t\t led0: %d led1: %d led2: %d\n\n", RadioRouteC$Leds$get() & 1, (RadioRouteC$Leds$get() & 2) / 2, (RadioRouteC$Leds$get() & 4) / 4);
    }
  RadioRouteC$AMControl$start();
}
...
#line 9
{
  ...
  if (is_sent) {
      switch (sending_msg_type) {
          case 0: 
            sim_log_debug(46U, "radio_send", "%s sent\n", "DATA_MSG");
          break;
          case 1: 
            sim_log_debug(47U, "radio_send", "%s sent\n", "ROUTE_REQ");
          break;
          case 2: 
            sim_log_debug(48U, "radio_send", "%s sent\n", "ROUTE_REP");
          break;
        }
    }
  else 
#line 25
    {
      switch (sending_msg_type) {
          case 0: 
            sim_log_debug(49U, "radio_rec", "%s received\n", "DATA_MSG");
          break;
          case 1: 
            sim_log_debug(50U, "radio_rec", "%s received\n", "ROUTE_REQ");
          break;
          case 2: 
            sim_log_debug(51U, "radio_rec", "%s received\n", "ROUTE_REP");
          break;
        }
    }
}
...
#line 357
{
  ...
  if (&RadioRouteC$packet[sim_node()] == bufPtr && error == SUCCESS) {
      sim_log_debug(180U, "radio_send", "Packet sent...\n");
      sim_log_debug_clear(181U, "radio_send", " at time %s \n", sim_time_string());
    }
  else {
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module RadioRouteC */
  if (!strcmp(varname, "RadioRouteC$rt"))
  {
    *addr = (uintptr_t)&RadioRouteC$rt[__nesc_mote];
    *size = sizeof(RadioRouteC$rt[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$round"))
  {
    *addr = (uintptr_t)&RadioRouteC$round[__nesc_mote];
    *size = sizeof(RadioRouteC$round[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$dbg_route_req_sent"))
  {
    *addr = (uintptr_t)&RadioRouteC$dbg_route_req_sent[__nesc_mote];
    *size = sizeof(RadioRouteC$dbg_route_req_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$dbg_route_rep_sent"))
  {
    *addr = (uintptr_t)&RadioRouteC$dbg_route_rep_sent[__nesc_mote];
    *size = sizeof(RadioRouteC$dbg_route_rep_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$dbg_route_req_received"))
  {
    *addr = (uintptr_t)&RadioRouteC$dbg_route_req_received[__nesc_mote];
    *size = sizeof(RadioRouteC$dbg_route_req_received[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$dbg_route_rep_received"))
  {
    *addr = (uintptr_t)&RadioRouteC$dbg_route_rep_received[__nesc_mote];
    *size = sizeof(RadioRouteC$dbg_route_rep_received[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$dbg_node_found"))
  {
    *addr = (uintptr_t)&RadioRouteC$dbg_node_found[__nesc_mote];
    *size = sizeof(RadioRouteC$dbg_node_found[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$in_RT"))
  {
    *addr = (uintptr_t)&RadioRouteC$in_RT[__nesc_mote];
    *size = sizeof(RadioRouteC$in_RT[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$curr_cost"))
  {
    *addr = (uintptr_t)&RadioRouteC$curr_cost[__nesc_mote];
    *size = sizeof(RadioRouteC$curr_cost[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$new_cost"))
  {
    *addr = (uintptr_t)&RadioRouteC$new_cost[__nesc_mote];
    *size = sizeof(RadioRouteC$new_cost[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$led_idx"))
  {
    *addr = (uintptr_t)&RadioRouteC$led_idx[__nesc_mote];
    *size = sizeof(RadioRouteC$led_idx[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$next_hop"))
  {
    *addr = (uintptr_t)&RadioRouteC$next_hop[__nesc_mote];
    *size = sizeof(RadioRouteC$next_hop[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$sending_msg_type"))
  {
    *addr = (uintptr_t)&RadioRouteC$sending_msg_type[__nesc_mote];
    *size = sizeof(RadioRouteC$sending_msg_type[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$msg"))
  {
    *addr = (uintptr_t)&RadioRouteC$msg[__nesc_mote];
    *size = sizeof(RadioRouteC$msg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$msg_received"))
  {
    *addr = (uintptr_t)&RadioRouteC$msg_received[__nesc_mote];
    *size = sizeof(RadioRouteC$msg_received[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module RadioRouteC */
  memset((void *)&RadioRouteC$rt[__nesc_mote], 0, sizeof RadioRouteC$rt[__nesc_mote]);
  memcpy((void *)&RadioRouteC$PERSON_CODE[__nesc_mote], (void *)&(char [9]){ '1', '0', '5', '8', '1', '1', '9', '7', '\0' }, sizeof RadioRouteC$PERSON_CODE[__nesc_mote]);
  ...
  RadioRouteC$round[__nesc_mote] = 0;
  RadioRouteC$dbg_route_req_sent[__nesc_mote] = FALSE;
  RadioRouteC$dbg_route_rep_sent[__nesc_mote] = FALSE;
  RadioRouteC$dbg_route_req_received[__nesc_mote] = FALSE;
  RadioRouteC$dbg_route_rep_received[__nesc_mote] = FALSE;
  RadioRouteC$dbg_node_found[__nesc_mote] = FALSE;
  memset((void *)&RadioRouteC$in_RT[__nesc_mote], 0, sizeof RadioRouteC$in_RT[__nesc_mote]);
  memset((void *)&RadioRouteC$curr_cost[__nesc_mote], 0, sizeof RadioRouteC$curr_cost[__nesc_mote]);
  memset((void *)&RadioRouteC$new_cost[__nesc_mote], 0, sizeof RadioRouteC$new_cost[__nesc_mote]);
  memset((void *)&RadioRouteC$led_idx[__nesc_mote], 0, sizeof RadioRouteC$led_idx[__nesc_mote]);
  memset((void *)&RadioRouteC$next_hop[__nesc_mote], 0, sizeof RadioRouteC$next_hop[__nesc_mote]);
  memset((void *)&RadioRouteC$sending_msg_type[__nesc_mote], 0, sizeof RadioRouteC$sending_msg_type[__nesc_mote]);
  memset((void *)&RadioRouteC$msg[__nesc_mote], 0, sizeof RadioRouteC$msg[__nesc_mote]);
  memset((void *)&RadioRouteC$msg_received[__nesc_mote], 0, sizeof RadioRouteC$msg_received[__nesc_mote]);
